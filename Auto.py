...
#except:
    #kok=open('/data/data/com.termux/files/usr/bin/.malangxxx-cov', 'w');kok.write(myid);kok.close()
#uid = os.getuid()
#key1 = open('/data/data/com.termux/files/usr/bin/.mrakingxxx-cov', 'r').read()
#kex=(f"Malang-Sarkar~CREATE:{uid}TS{key1}110E==")
...
def clear():
    ...
    os.system("clear")
    print("""   
\x1b[1;26mMM    MM   AAA   LL        AAA   NN   NN   GGGG  
\x1b[1;36mMMM  MMM  AAAAA  LL       AAAAA  NNN  NN  GG  GG 
\x1b[1;32mMM MM MM AA   AA LL      AA   AA NN N NN GG      
\x1b[1;15mMM    MM AAAAAAA LL      AAAAAAA NN  NNN GG   GG 
\x1b[1;26mMM    MM AA   AA LLLLLLL AA   AA NN   NN  GGGGGG       
------------------------------------------
 Author : Malang Sarkar
 Github : YAD NI AA RAHA
 Tools  : Auto Create
 Contact: 03014108661
 Version: 0.7
\033[1;26m------------------------------------------""") 
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write('\r\r\033[1;37m [MALANG-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [Malang-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
           ...
           pass
    file="/sdcard/YCREATE-OK.txt"
    u=5000
    clear()
    print(' Use Airplane Or Use IP Changer if ids coming cp ')
    print(' ids will be save in /sdcard/Malang/CREATE-OK.txt')
    linex()
