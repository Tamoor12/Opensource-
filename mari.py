...
def ua_api():
    ...
    return (f"Dalvik/2.1.0 (Linux; U; Android {vers}; {verq} Build/{xnxx}) [FBAN/FB4A;FBBV/3952373;FBAV/68.0.0.3927;FBDV/{verq};FBLC/es_AR;FBNG/WIFI;FBMNT/METERED;FBDM/"+"{density=0.75}]")
