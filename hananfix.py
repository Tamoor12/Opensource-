...
def method():
    ...
    def start(user):
     try:
        ...
        loop+=1
        for pswd in pp:
              heads="Dalvik/2.1.0 (Linux; U; Android 10; X Build/QP1A.970291.140))[FBAN/FB4A;FBAV/68.0.0.1177;FBBV/5216567;[FBAN/FB4A;FBAV/196.0.0.36;FBBV/387366018;FBDM/{density=1.5,width=720,height=1920};FBLC/en_CA;FBRV/282475346;FBCR/China Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A5009;FBSV/7.5.1;nullFBCA/armeabi-v7a:armeabi;]"
